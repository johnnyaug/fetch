function showOptionImage(optionId, optionValue, imgSrc) {
	$('#option-' + optionId + '-img').remove();
	$(
			'<img id="option-'
					+ optionId
					+ '-img" src="'
					+ imgSrc
					+ '" style="position: absolute;top:0;bottom:0;display:block;"/>')
			.appendTo('.thumbnails__big-image');
}

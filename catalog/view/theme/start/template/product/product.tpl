	          ...
	          <ul class="thumbnails">
		          <?php if ($thumb) { ?>
			          <div class="thumbnails__big-image" style="max-width: <?php echo $config->get('config_image_thumb_width'); ?>px; max-height: <?php echo $config->get('config_image_thumb_height'); ?>px;">	          
			          	  	<a href="<?php echo $popup; ?>" class="product-image-link" style="">
          ...
          <div id="product">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>">
                ...
                <div class="radio">
                  <label>
                    <input type="radio" onclick="showOptionImage(<?php echo $option['product_option_id']?>, <?php echo $option_value['product_option_value_id']?>, '<?php echo $option_value['image-actual']?>');" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" />
                    <img class="actual" style="display:none;height:'<?php echo $config->get('config_image_thumb_height');?>px';width='<?php echo $config->get('config_image_thumb_width');?>px';>" src="<?php echo $option_value['image-actual']?>"/>
                    <img class="thumb" src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" class="img-thumbnail" /> <?php echo $option_value['name']; ?>
                    <?php if ($option_value['price']) { ?>
                    (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
                    <?php } ?>
                  </label>

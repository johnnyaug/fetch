			...
			<div class="row">
				<?php if ($informations) { ?>
					<div class="col-md-3 col-sm-6 col-xs-12">
						<h3 class="box-heading box-heading--footer"><?php echo $text_information; ?></h3>
						<ul>
				...
				<?php } ?>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<h3 class="box-heading box-heading--footer"><?php echo $text_service; ?></h3>
					<ul>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<h3 class="box-heading box-heading--footer"><?php echo $text_extra; ?></h3>
					<ul>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<h3 class="box-heading box-heading--footer"><?php echo $text_account; ?></h3>
					<ul>
				...
				<div class="newsletter">
					...
					<?php } ?>
						<form id="newsletter-form">
							<div class="row">
								<div class="col-lg-3 col-md-3 hidden-xs hidden-sm hidden-md">
									<?php echo $kuler->translate($kuler->getSkinOption('newsletter_description_text')); ?>
								</div>
								<div class="col-lg-5 col-md-8 no-padding-lg no-padding-md">
								...
								<div class="col-lg-4 col-md-4 no-padding-lg no-padding-md">
									<button id="newsletter-submit" class="newsletter__submit-button">
										<?php echo $kuler->translate($kuler->getSkinOption('newsletter_button_text')); ?>
									</button>
								</div>
							</div>
						</form>

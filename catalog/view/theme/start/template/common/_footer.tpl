<?php
$footer_address = Kuler::getInstance()->getModules('footer_address');
if (!empty($footer_address)) { ?>
	<?php $class = 'have-contact-form'; ?>
<?php } else{?>
	<?php $class = 'no-contact-form'; ?>
<?php } ?>
<footer id="footer" class="footer <?php echo $class; ?>">
		...
		<div class="row">
			<div class="col-lg-9">
				<div class="footer__left">
					...
					<div class="row">
						<?php
						$modules_extra_info = Kuler::getInstance()->getModules('footer_extra');
						if ($modules_extra_info) { ?>
							<div class="col-lg-7 col-md-6 col-sm-6">
								<?php	echo implode('', $modules_extra_info); ?>
							</div>

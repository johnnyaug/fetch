...
class ControllerModuleKulerTestimonial extends Controller
{
	...
	public function index()
	{
		...
		$module_data = $this->model_setting_setting->getSetting('kuler_testimonial', $this->data['store_id']);

		if (!is_array($module_data))
		{
			$module_data = array();
		}
		$this->data['status']       = isset($module_data['kuler_testimonial_status']) ? $module_data['kuler_testimonial_status'] : '1';
		$this->data['modules']      = isset($module_data['kuler_testimonial_module']) ? $module_data['kuler_testimonial_module'] : array();
	...
	public function save()
	{
		try
		{
			...
			$data = array(
				'kuler_testimonial_status' => $this->request->post['status'],

...
class ControllerModuleKulerFilter extends Controller {
	...
	public function index() {
        ...
        $module_data = $this->model_setting_setting->getSetting('kuler_filter', $this->data['store_id']);
        ...
        $this->data['status']       = isset($module_data['kuler_filter_status']) ? $module_data['kuler_filter_status'] : '1';
        $this->data['modules']      = isset($module_data['kuler_filter_module']) ? $module_data['kuler_filter_module'] : array();
    ...
    public function save()
    {
        try
        {
            ...
            $data = array(
                'kuler_filter_status' => $this->request->post['status'],
                'kuler_filter_module' => isset($this->request->post['modules']) ? $this->request->post['modules']: array()
            );

            $this->load->model('setting/setting');

            $this->model_setting_setting->editSetting('kuler_filter', $data, $this->request->post['store_id']);

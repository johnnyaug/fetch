                        ...
                        <table class="form">
                                ...
                                <td>
	                                <div class="col-sm-4">
		                                <div class="input-group date">
			                                <input type="text" name="article[article][date_added]" value="<?php echo $article['article']['date_added_formatted']; ?>"  data-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
                            ...
                            <tr>
                                ...
                                <td>
	                                <div class="col-sm-4">
		                                <div class="input-group date">
			                                <input type="text" name="article[article][date_modified]" value="<?php echo $article['article']['date_modified_formatted']; ?>"  data-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
						                    <span class="input-group-btn">
						                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
						                    </span>
		                                </div>
